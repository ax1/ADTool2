...
//     }
	...
	public void removed(CControl control, CDockable dockable) {
		...
		if (dockable instanceof TreeDockable && lastFocusedTree instanceof AbstractTreeCanvas) {
			...
			if (lastFocusedTree != null && uid.equals(
...
//     }
	...
	private JMenu createFileMenu() {
		...
		menuItem = fileMenu.add(fileSIMULATE);
		menuItem.addMouseListener(mouseHandler);
	...
	private void createActions() {
		...
		fileSIMULATE = new ADAction("SIMULATE") {
			public void actionPerformed(final ActionEvent e) {
				Simulator.simulate();
			}

			private static final long serialVersionUID = 4509590774645645107L;
		};

		// fileSIMULATE.setMnemonic(KeyStroke.getKeyStroke(Options.getMsg("file.newADT.key")));
		fileSIMULATE.setAccelerator(KeyStroke.getKeyStroke("F5"));
		fileSIMULATE.setSmallIcon(iconFac.createImageIcon("/icons/simulate.png"));
		fileSIMULATE.setToolTip("Simulate the current tree within  a range of values");
...
//           lastFocusedTree.fitToWindow();
	...
	private static ADAction fileSIMULATE;
