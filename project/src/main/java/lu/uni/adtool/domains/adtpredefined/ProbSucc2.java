...
/**
 * Copy of ProbSucc.java but different calc(). This class is only for testing on
 * development
 *
 */
public class ProbSucc2 implements AdtDomain<RealZeroOne> {
	...
	public RealZeroOne calc(RealZeroOne a, RealZeroOne b, ADTNode.Type type) {
		...
		/*
		 * switch (type) { case OR_OPP: return RealZeroOne.plusProb(a, b); case AND_OPP:
		 * return RealZeroOne.times(a, b); case OR_PRO: return RealZeroOne.plusProb(a,
		 * b); case AND_PRO: return RealZeroOne.times(a, b); default: return
		 * RealZeroOne.times(a, b); }
		 */
	}
